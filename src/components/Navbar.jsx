...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-full'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            ...
            {/* jika Button di remove menu navbar akan disebelah kanan */}
            {/* <button className='hidden md:block bg-white px-8 py-8 rounded-full'>Sign Up</button> */}
        ...
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full': 'w-0 h-0'} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
          <div className='flex justify-end p-6 cursor-pointer'>
            <img onClick={() => setShowMobileMenu(false)} src={assets.cross_icon} alt='' className='w-7' />
          </div>
